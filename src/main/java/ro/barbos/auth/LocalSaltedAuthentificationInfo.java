 ...
 */
public class LocalSaltedAuthentificationInfo implements SaltedAuthenticationInfo {
    ...
    public LocalSaltedAuthentificationInfo(String username, String password, String salt) {
