...
public class LumberLogTransportCertificateDAO extends EntityDAO<LumberLogTransportCertificate> {
    ...
    public List<LumberLogTransportCertificate> findAll(Long supplierId) {
        Logger logger = Logger.getLogger("dao");
        List<LumberLogTransportCertificate> results = null;

        StringBuilder sql = new StringBuilder("select Id,EntryDate,Code,CodeCreationTime,SerialCode, SerialNo,Document,LoadPlace,TransportLeaveDate,UnloadPlace,TransportArrivalDate,DocCreator,DocCreatorName,TransportName,TransportPlate,DriverName,DriverId,SupplierId from LumberLogTransportCertificate where SupplierId=" + supplierId + " order by Id");
